...
<p>
	...
	-->
	<a style="font-weight: normal" href="<?php echo WP_PLUGIN_URL.'/seer-contact-exporter/ajax.php?delete_all_seomoz_data=1' ?>"><button class="button-primary">Reset all Page Authority / Domain Authority »</button></a>
</p>
...
function update_seomoz_for(url, cid) {
	...
	jQuery.post("<?php echo plugins_url( 'seer-contact-exporter/ajax.php' ); ?>", {"url": url},
		function (data) {
			try {
				res= eval('('+data+')');
				err=0;
